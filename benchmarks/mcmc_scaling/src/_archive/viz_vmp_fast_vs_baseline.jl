...
const CSV_PATH    = joinpath(RESULTS_DIR, "vmp_fast_both_n250_d10_50iter.csv")
...
Label(fig[0, 1],
      ...
      "N=250, D=10, 50 iterations.  Lower FE = better q(·) fit.",
...
save(joinpath(RESULTS_DIR, "vmp_fast_vs_baseline_n250_d10.png"), fig; px_per_unit=2)
save(joinpath(RESULTS_DIR, "vmp_fast_vs_baseline_n250_d10.pdf"), fig)
println("Saved vmp_fast_vs_baseline_n250_d10.{png,pdf}")
