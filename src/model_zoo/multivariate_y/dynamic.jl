@model function multivariate_dynamic_ensemble(n_forecasters, n_obs, features, predictions, y, priors)
    local w, z, γ, τ, β
...
@constraints function multivariate_dynamic_ensemble_constraints()
