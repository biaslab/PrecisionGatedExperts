@model function multivariate_dynamic_diagonal_ensemble(
    n_forecasters,
    n_obs,
    features,
    predictions,
...
@constraints function multivariate_dynamic_diagonal_ensemble_constraints(priors, prediction)
...
@initialization function multivariate_dynamic_diagonal_ensemble_init(priors)
