@model function univariate_dynamic_diagonal_ensemble(
    n_forecasters,
    n_obs,
    features,
    predictions,
...
@constraints function univariate_dynamic_diagonal_ensemble_constraints(priors, prediction)
...
@initialization function univariate_dynamic_diagonal_ensemble_init(priors)
